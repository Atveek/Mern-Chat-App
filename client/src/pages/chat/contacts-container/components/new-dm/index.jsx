      ...
      <Dialog open={openNewContactModel} onOpenChange={setOpenNewContactModel}>
        <DialogContent className="bg-[#181920] border-none text-white w-[400px] h-[400px] flex flex-col ">
          ...
          {searchContact.length <= 0 ? (
            <div className="flex-1 md:bg-[#1c1d25] flex-col md:flex justify-center items-center duration-100 transition-all mt-5">
              <Lottie
            ...
            <ScrollArea className="h-[250px]">
              <div className="flex flex-col gap-5">
                {searchContact.map((contact) => (
                  <div
                    key={contact._id}
                    className="flex gap-3 items-center contain-paint cursor-pointer"
                  ...
                  >
                    <div className="flex items-center justify-center gap-3">
                      <div className="w-12 h-12">
                        <Avatar className="h-12 w-12 md:w-12 md:h-12 rounded-full overflow-hidden">
                          {contact.image ? (
                            ...
                            <div
                              className={`uppercase h-12 w-12 md:w-12 md:h-12 text-lg border-[1px] flex justify-center items-center rounded-full ${getColor(
                                contact.color
                              )}`}
                            >
                              {contact.firstName
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="text-xs mt-1">{contact.email}</span>
                      </div>
                    </div>
                  </div>
                ))}
